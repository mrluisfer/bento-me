...
export const ProfileInfo = () => {
  return (
    <header className="pt-4 sm:pt-8 lg:pt-16 lg:sticky lg:top-16 self-start mb-8 lg:mb-0">
      <Avatar className="size-24 sm:size-32 lg:size-46 mt-2 sm:mt-4 mx-auto md:mx-0">
        <AvatarImage
          src="/profile.webp"
      ...
      <div className="mt-4 sm:mt-6 lg:mt-8 ml-0 sm:ml-2">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4 sm:mt-8 lg:mt-12 text-center md:text-left">
          Luis Alvarez
        </h1>
        <p className="text-base sm:text-lg lg:text-xl mt-2 sm:mt-3 text-muted-foreground max-w-prose md:max-w-75 xl:max-w-none text-center md:text-left">
